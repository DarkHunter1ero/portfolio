...
export const projectDetailsEs: ProjectDetail[] = [
  {
    ...
    architecture: {
      ...
      reactFlowData: {
        direction: "TB",
        nodes: [
          { id: "User", data: { label: "👤 Empleado", variant: "user" } },
          { id: "Admin", data: { label: "👨‍💼 Administrador de Empresa", variant: "user" } },
          { id: "Frontend", data: { label: "Frontend Angular", variant: "frontend" } },
          { id: "Monolith", data: { label: "Groovy / Grails", variant: "service" } },
          { id: "Auth", data: { label: "Autenticación y Autorización", variant: "service" } },
          { id: "Payroll", data: { label: "Procesamiento Batch de Nómina", variant: "service" } },
          { id: "Documents", data: { label: "Recibos Electrónicos", variant: "service" } },
          { id: "Signature", data: { label: "Flujo de Firma Digital", variant: "service" } },
          { id: "Notifications", data: { label: "Notificaciones\nWeb + Email", variant: "service" } },
          { id: "DB", data: { label: "Base de Datos MySQL", variant: "database" } },
          { id: "Mail", data: { label: "Servidor de Correo", variant: "external" } },
        ],
        edges: [
  ...
  },
  {
    ...
    architecture: {
      ...
      reactFlowData: {
        direction: "LR",
        nodes: [
          { id: "Client", data: { label: "👤 Usuario", variant: "user" } },
          { id: "Auth", data: { label: "🔐 Servidor de Autenticación\nSpring Boot\nEmbedded WildFly\nOAuth2\nJWT\n2FA / OTP\nThymeleaf UI", variant: "service" } },
          { id: "Crypto", data: { label: "🔑 Servicios Criptográficos\nSpring Boot\nEmbedded WildFly\nCiclo de Vida de Certificados\nFirma de Documentos", variant: "service" } },
          { id: "CA", data: { label: "📜 Gestión de CA\nSpring Boot\nEmbedded WildFly\nEmisión de Certificados\nRevocación de Certificados\nEnrutamiento Multi-CA", variant: "service" } },
          { id: "AuthDB", data: { label: "PostgreSQL", variant: "database" } },
          { id: "CryptoDB", data: { label: "PostgreSQL", variant: "database" } },
          { id: "HSM", data: { label: "🏛 HSM", variant: "hardware" } },
          { id: "KeyOne", data: { label: "KeyOne CA", variant: "external" } },
          { id: "Gateway", data: { label: "CA Gateway", variant: "external" } },
        ],
        edges: [
  ...
  },
  {
    ...
    gallery: [
      { src: "/images/tuid-firma.jpg", alt: "FirmaPDF — Interfaz de firma digital TuID" },
      { src: "/images/tuid.jpg", alt: "Plataforma de identidad digital TuID" },
      { src: "/images/tuid2.jpg", alt: "Autenticación y verificación de identidad TuID" },
