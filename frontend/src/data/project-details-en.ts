...
export const projectDetailsEn: ProjectDetail[] = [
  {
    ...
    architecture: {
      ...
      reactFlowData: {
        direction: "TB",
        nodes: [
          { id: "User", data: { label: "👤 Employee", variant: "user" } },
          { id: "Admin", data: { label: "👨‍💼 Company Administrator", variant: "user" } },
          { id: "Frontend", data: { label: "Angular Frontend", variant: "frontend" } },
          { id: "Monolith", data: { label: "Groovy / Grails", variant: "service" } },
          { id: "Auth", data: { label: "Authentication & Authorization", variant: "service" } },
          { id: "Payroll", data: { label: "Payroll Batch Processing", variant: "service" } },
          { id: "Documents", data: { label: "Electronic Payslips", variant: "service" } },
          { id: "Signature", data: { label: "Digital Signature Workflow", variant: "service" } },
          { id: "Notifications", data: { label: "Notifications\nWeb + Email", variant: "service" } },
          { id: "DB", data: { label: "MySQL Database", variant: "database" } },
          { id: "Mail", data: { label: "Mail Server", variant: "external" } },
        ],
        edges: [
